---
title: "Lowland tapirs (*Tapirus terrestris*) as ecosystem engineers: selective sapling breakage and its structural consequences in Yungas Andean forests"
...
library(tidyverse)
library(knitr)
library(kableExtra)  # EL PAQUETE kableExtra también requiere el paquete LaTeX: float
library(float)
library(xtable)
library(waffle)
library(treemapify)
